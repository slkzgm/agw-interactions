// Path: src/lib/gachasConstants.ts

export const GACHAS_ABI = [
  {
    inputs: [
  ...
  { inputs: [], name: "ValidatorCalledFailed", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
...
export const GACHAS_CONTRACT_ADDRESS =
