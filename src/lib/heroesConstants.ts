export const HEROES_ABI = [
  {
    inputs: [
      { internalType: "string", name: "_name", type: "string" },
      { internalType: "string", name: "_symbol", type: "string" },
      { internalType: "address", name: "_owner", type: "address" },
      { internalType: "uint40", name: "ogTimestamp", type: "uint40" },
      { internalType: "uint40", name: "wlTimestamp", type: "uint40" },
      { internalType: "uint40", name: "og2Timestamp", type: "uint40" },
      { internalType: "uint40", name: "pbTimestamp", type: "uint40" },
    ],
  ...
  { inputs: [], name: "PhaseAlreadyStarted", type: "error" },
  { inputs: [], name: "PublicMintStarted", type: "error" },
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "to", type: "address" },
      { internalType: "uint64", name: "paidMintQty", type: "uint64" },
      { internalType: "uint64", name: "numOfRing", type: "uint64" },
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "to", type: "address" },
      { internalType: "bool", name: "freeMint", type: "bool" },
      { internalType: "uint64", name: "paidMintQty", type: "uint64" },
      { internalType: "uint64", name: "numOfRing", type: "uint64" },
      { internalType: "bytes32[]", name: "_merkleProof", type: "bytes32[]" },
    ],
  ...
  {
    inputs: [
      { internalType: "bytes32", name: "ogRoot", type: "bytes32" },
      { internalType: "bytes32", name: "wlRoot", type: "bytes32" },
    ],
    name: "setRoot",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint40", name: "newTimeStamp", type: "uint40" },
    ],
    name: "setTimestamp",
    outputs: [],
    stateMutability: "nonpayable",
...
// 3) Contract address
export const HEROES_CONTRACT_ADDRESS =
  "0x7c47ea32FD27d1a74Fc6e9F31Ce8162e6Ce070eB" as const;
